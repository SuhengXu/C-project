#include<stdio.h>
#include<stdlib.h>//标准数据Standred Library
#include<string.h>
#include<wchar.h>//用来支持宽字符相关的函数以对汉字进行操作
#include<locale.h>
#ifndef _HEAD_H_
#define _HEAD_H_
/*预设的几种消费类型*/
...
void Research(pINAEX head);//查询数据
int Calender(int, int, int);//判断日期是否存在
//int SafeInputCheck(wchar_t wcArray[20],int iLimit);//确保输入的字符不会超出数组容量
